...
\begin{document}
\title{GMMAT: Generalized linear Mixed Model Association Tests\\Version 0.9.2}
\date{June 8, 2018}
...
The current version of the \textit{GMMAT} package (version 0.9.1) is also available in Analysis Commons \cite{Brody2017} on DNAnexus cloud computing platform (\url{https://platform.dnanexus.com/}), as the "gmmat\_v0.9.1" App in Project "Commons\_Tools".

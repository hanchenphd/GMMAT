...
\begin{document}
\title{GMMAT: Generalized linear Mixed Model Association Tests\\Version 1.0.1}
\date{January 1, 2019}
...
\textit{GMMAT} can be downloaded at \url{https://github.com/hanchenphd/GMMAT}. It can be installed as a regular R package.

\subsection{Installing \textit{GMMAT}}
Before installing \textit{GMMAT}, please check your system to make sure C++ libraries \href{http://www.boost.org/}{boost} and \href{http://arma.sourceforge.net/}{Armadillo} have been installed appropriately. \textit{GMMAT} links to R packages \href{https://cran.r-project.org/web/packages/Rcpp/index.html}{Rcpp}, \href{https://cran.r-project.org/web/packages/RcppArmadillo/index.html}{RcppArmadillo} and \href{https://cran.r-project.org/web/packages/BH/index.html}{BH}, and also imports R packages \href{https://cran.r-project.org/web/packages/Rcpp/index.html}{Rcpp}, \href{https://cran.r-project.org/web/packages/CompQuadForm/index.html}{CompQuadForm}, \href{https://cran.r-project.org/web/packages/foreach/index.html}{foreach}, \href{https://cran.r-project.org/web/packages/doMC/index.html}{doMC}, \href{https://cran.r-project.org/web/views/HighPerformanceComputing.html}{parallel}, Bioconductor packages \href{http://bioconductor.org/packages/release/bioc/html/SeqArray.html}{SeqArray} and \href{http://bioconductor.org/packages/release/bioc/html/SeqVarTools.html}{SeqVarTools}. In addition, \textit{GMMAT} requires \href{https://cran.r-project.org/web/packages/testthat/index.html}{testthat} to run code checks during development. These dependencies should be installed before installing \textit{GMMAT}.
...
The current version of the \textit{GMMAT} package (version 1.0.0) is also available in Analysis Commons \cite{Brody2017} on DNAnexus cloud computing platform (\url{https://platform.dnanexus.com/}), as the "gmmat\_v1.0.0" App in Project "Commons\_Tools".
...
All matrices must be positive semi-definite.
...
\bibitem{Chen2019} Chen, H., Huffman, J. E., Brody, J. A., Wang, C., Lee, S., Li, Z., Gogarten, S. M., Sofer, T., Bielak, L. F., Bis, J. C., \textit{et al.} Efficient variant set mixed model association tests for continuous and binary traits in large-scale whole-genome sequencing studies. \textit{The American Journal of Human Genetics} (in press 2019).
